...
function ProductListScreen() {
    ...
    const { loading: productLoading, error:productError, success:productSuccess, product:createdProduct} = productCreate
    ...
    }, [dispatch, navigate, userInfo, successDelete, productSuccess, createdProduct])
